...
import Project2 from '../images/projects/trucoscreenshot.png';
        ...
        return(
          <Layout>
            ...
            <div className="projects">
              <div className="item">
                <a href="https://getonhealth.ca/" target="_blank" rel="noopener noreferrer">
                  <img src={Project1} alt="project1" />
                </a>
                <a href="https://getonhealth.ca/" target="_blank" rel="noopener noreferrer" className="btn-light"><i className="fas fa-eye"></i>Get On Health</a>
              ...
              <div className="item">
                <a href="https://trucocoatings.com/" target="_blank" rel="noopener noreferrer">
                  <img src={Project2} alt="project2" />
                </a>
                <a href="https://trucocoatings.com/" target="_blank" rel="noopener noreferrer" className="btn-light"><i className="fas fa-eye"></i>Truco Coatings</a>
